...
public class DriverCode {
    ...
    public static void main(String args[]) {
        ...
        m3.initiateCoinsend("102", DSObj);Pair<List<Pair<String, String>>,List<Pair<String, String>>> temp ;
        try {
            m2.MineCoin(DSObj);
        ...
        TransactionBlock tb1 = DSObj.bChain.lastBlock.previous.previous.previous ; // For the coinsrc_block in this try-catch block.
        try {
            Transaction tobj = new Transaction();
            tobj.Source = m3;
            tobj.Destination = m2;
            tobj.coinID = "100002";
            tobj.coinsrc_block = tb1 ;
